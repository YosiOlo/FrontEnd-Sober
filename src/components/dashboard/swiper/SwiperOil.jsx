...
import { getProductMinyak } from '../../../utils/ApiConfig';
...
function SwiperOil() {
    ...
    const toggleFavorite = async (spice) => {
        const data = await getProductMinyak();
        ...
        <div className="main-content relative p-4">
            <div className="top flex justify-between mb-5">
                <div className="content_left flex">
                    <h3 className='text-4xl font-semibold'>Minyak dan Bumbu</h3>
